...
tagline: "FIFO is better than LRU"
excerpt_separator: "<!--more-->"
excerpt: "This blog shows why FIFO is better than LRU and the secrets behind a good cache eviction algorithm."
# header:
author_profile: true
comments: true
related: true
...
sidebar:
  - title: ""
    image: "/assets/posts/2023-06-01-fifo-lru/LEGO.png"
    image_alt: "Design cache eviction algorithms like building LEGOs"
    text: "Lazy promotion enables high throughput and scalability, and quick demotion enables high efficiency."
...
{% include image.html 
url="/assets/posts/2023-06-01-fifo-lru/cacheAbs.svg" width="80%"
description="A cache can be viewed as a logically ordered queue with four operations: insertion, removal, promotion and demotion. Most eviction algorithms are promotion algorithms. "%}
...
{% include image4.html 
url1="/assets/posts/2023-06-01-fifo-lru/multi_LRU_FIFO_Reinsertion_1.svg" 
url2="/assets/posts/2023-06-01-fifo-lru/multi_LRU_Clock-2_1.svg"
url3="/assets/posts/2023-06-01-fifo-lru/multi_LRU_FIFO_Reinsertion_3.svg"
url4="/assets/posts/2023-06-01-fifo-lru/multi_LRU_Clock-2_3.svg"
description="Comparison of FIFO-Reinsertion, 2-bit CLOCK and LRU on 10 datasets with 5307 traces. Left two: small cache, right two: large cache. A longer bar means the algorithm is more efficient (having lower miss ratios on more traces). Note that we do not consider the overhead of LRU metadata in all the evaluations." %}
...
{% include image.html 
url="/assets/posts/2023-06-01-fifo-lru/LP.svg" width="48%"
description="FIFO-Reinsertion demotes new objects faster than LRU because objects requested before the new object also pushes it down the queue."%}
...
{% include image.html 
url="/assets/posts/2023-06-01-fifo-lru/QD.svg" width="48%"
description="An example of quick demotion: adding a small FIFO to filter most new objects that do not have a request soon after insertion." %}
...
{% include image2.html 
url1="/assets/posts/2023-06-01-fifo-lru/block_1.svg" 
url2="/assets/posts/2023-06-01-fifo-lru/block_3.svg"
description="On the block traces, quick demotion can improve most state-of-the-art algorithm's efficiency. Left: small cache, right: large cache. " %}


{% include image2.html 
url1="/assets/posts/2023-06-01-fifo-lru/web_1.svg"
url2="/assets/posts/2023-06-01-fifo-lru/web_3.svg"
description="On the web traces, quick demotion can improve all state-of-the-art algorithm's efficiency. Left: small cache, right: large cache. " %}
...
This work is published at HotOS'23, more details can be found [here](https://jasony.me/publication/hotos23-qdlp.pdf), and the slides can be found [here](https://jasony.me/slides/hotos23-qdlp.pdf). 
